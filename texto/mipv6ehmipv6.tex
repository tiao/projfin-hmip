...
O funcionamento do MAP é semelhante ao do agente domiciliar, ele intercepta pacotes destinados ao RCoA originado pelo agente domiciliar ou nós correspondentes, então os envia via túnel bidirecional, estabelecido entre o MAP, ao LCoA. Este túnel é usado para enviar todos os pacotes oriundos do nó móvel, exceto os com destino aos correspondentes locais.
...
A figura \ref{f_hmipv6} ilustra um cenário com dois dominio HMIPv6, onde o nó móvel se atrela ao \textit{site 1} através do roteador de acesso 1, e inicia uma comunicação com o Nó correspondente. Após isso realiza uma mobilidade local, passando a ter o roteador de acesso 2 como roteador padrão. Por último realiza uma mobilidade global, mudando o roteador padrão e o MAP.
...
A figura Y apresenta a sequência de mensagens trocadas durante a movimento do nó móvel no cenário da figura \ref{f_hmipv6}.
