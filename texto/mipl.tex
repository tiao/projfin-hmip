...
de Monash \cite{moore}, baseando-se no MIPL 0.94 e na versão 2.4 do \textit{kernel linux}.
...
terminal controlador \cite{stevens2005unp}. Este mesmo \textit{daemon} desempenha o
...
envio de pacotes puramente IP sem a interferência do \textit{kernel}\cite{rfc3542}.
