...
$<$estampa\_tempo$>$ IP6 ( .. next header $<$tipo\_next\_header$>$ ..) $<$endereço\_fonte$>$ \\ $<$endereço\_destino$>$
...
Na realização do segundo cenário, foi possível verificar minimamente o funcionamento
