...
\raisebox{1.5ex}{Nó} & \raisebox{1.5ex}{Interface} & \raisebox{1.5ex}{MAC} &
\raisebox{1.5ex}{Endereço} & \raisebox{1.5ex}{Tipo}\\ \hline
% MN
...
mobilidade para a outra rede. No instante entre o ICMP reply X e o RA recebido é
o perio que o nó móvel realiza o movimento.
...
\ref{t_rot_ha1}, após receber o \textit{Binding Update} e o agente domiciliar
criar o túnel com o nó móvel, é adicionada a seguinte rota a sua tabela de
roteamento, que todos os pacotes com destino ao endereço domiciliar devem ser
encaminhados para o túnel. E no nó móvel os pacotes com destino ao nó
correspondente e ao agente domiciliar são encaminhados pelo túnel,
...
salto} & \raisebox{1.5ex}{Considerações}\\ \hline
...
\raisebox{1.5ex}{Destino} & \raisebox{1.5ex}{Conteúdo}\\ \hline
...
\subsection{Análise dos Tempos de Handover}
