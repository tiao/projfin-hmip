...
nó correspondente, são enviandos, via túnel, ao Agente Domiciliar (túnel
...
de cabeçalho de extenção de roteamento\cite{koodli2007min}.
...
token}. utilizado pelo nó móvel para gerar a chave \textit{Kbm};
 \item \textbf{\ac{CoTI}}: mensagem envianda pelo nó
...
Quando um nó movel entra em um domínio com a presença de um MAP, ele
...
informaçãos recebidas das mensagens RA do MAP 1 e, encaminhar para suas
...
mensagem de BU deve ser envianda utilizando a opção de
...
domínios esse é o mescanismo padrão.
 \end{description}
