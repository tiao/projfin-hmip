...
E no nó móvel aparentemente a única mudança é o roteador padrão.
...
\raisebox{1.5ex}{Prioridade} & \raisebox{1.5ex}{Regra} & \raisebox{1.5ex}{Ação}
\\ \hline
...
\begin{small}
  \setlength{\tabcolsep}{3pt}
\begin{tabular}{|c|c|c|c|c|}\hline
\raisebox{1.5ex}{Nome} & \raisebox{1.5ex}{Remoto} & \raisebox{1.5ex}{Local} & 
\raisebox{1.5ex}{Interface} & \raisebox{1.5ex}{Considerações} \\ \hline
...
\begin{figure}[!htpb]
	\centering
	\includegraphics[scale=.35]{figs/cenario2}
