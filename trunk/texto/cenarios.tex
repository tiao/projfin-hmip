...
dos cenários, é uma conexão utilizando o protocolo da camada transporte TCP.
...
Nas listagens do tcpdump, utilizadas na seções que se seguem, os pacotes serão
...
É interessante lembrar que os Router Advertisments são mensagens ICMP6, assim
como os \textit{echo-request} e \textit{echo-reply} produzidos pelo ping. 

O tcmpdump apresenta os cabeçalhos de mobilidade (BU e BA) com
\textit{next-header
...
\textit{echo request} do nó correspondente (src=2001:a::fcfd:65ff:fe34:8a44) e
 \textit{Router Advertisement} do Agente domiciliar
(src=fe80::fcfd:f5ff:fe49:32bc);
