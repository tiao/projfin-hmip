...
O tempo de latência de um \textit{handover} segundo [](por referência) pode ser dividida em quatro fases, a partir dos dados colhidos com Cenário 1 vamos tentar reproduzi-las, exemplificando com os nossos tempos:
\begin{enumerate}
